...
export default function Philosophy() {
  return (
    <div className="flex items-center justify-center flex-col p-10">
      <h1 className="font-bold text-base text-[#1f80f0] montserrat-font leading-6">
        OUR PHILOSOPHY
      </h1>
      <p className="montserrat-font font-semibold text-[56px] leading-[62px] text-[0b305b] mt-3">

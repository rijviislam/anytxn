...
export default function Navbar() {
  ...
  return (
    <div className="flex items-center justify-center z-50 bg-transparent  top-0 absolute w-full">
      <div className=" flex items-center  justify-between  w-[1200px] lg:px-2 lg:py-7 ">
        ...
        <div>
          <ul className="flex gap-5 inter-font font-normal text-[#FFF]  text-base left-[26px]  items-center">
            ...
            <Link href="#" className=" hover:border-b border-white py-3 px-4 ">
              Services
            </Link>
            <Link href="#" className=" hover:border-b border-white py-3 px-4  ">
              About Us
            </Link>
            <button className="flex items-center gap-2 border border-white py-2 px-3 rounded-full uppercase">
              <svg
                width="12"
                height="13"
                viewBox="0 0 12 13"
        ...
        <div className="relative inline-block">
          <button
            ...
            className="group inter-font font-semibold text-lg text-white border border-white py-3 px-8 flex items-center gap-2 hover:bg-white hover:text-[#1f80f0]"
          >
            Contact Us
            <svg

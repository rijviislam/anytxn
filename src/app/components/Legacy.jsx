    ...
    <div className="">
      <div className="relative h-[500px] legacy overflow-hidden w-full md:w-full flex items-center justify-start border-none mt-10 lg:mt-0">
        <div className="pl-20  lg:ml-[10px] relative z-30 xs:pl-5">
          ...
          {/* <button className="bg-[#FE8B53] px-10 py-3 rounded-md text-white font-semibold inter-font text-lg hover:bg-[#ff894e] transition flex items-center gap-2 shadow-2xl">
            Contact Us
            <svg
              className="w-3 h-3"
              viewBox="0 0 6 9"
          ...
          <button className="group bg-[#FE8B53] px-10 py-3 rounded-md text-white font-semibold inter-font text-lg hover:bg-[#ff894e] transition flex items-center gap-2 shadow-2xl">

...
export default function Banner() {
  return (
    <div className=" w-full  flex justify-center items-center relative overflow-hidden ">
      ...
      <div className="w-[1200px]  absolute left-10 top-[130px] z-50">
        <div className="  w-[700px]">
          <h1 className="montserrat-font font-semibold text-[80px] leading-[92px] text-[#FFF]">
      ...
      <div
        ...
        style={{
          clipPath: "polygon(10% 130%, 150% -140%, 100% 62%, -10% 200%)",
        }}
      >
        <Image
          className="object-contain h-[115%] w-[115%]"
          src={Bannerimg}
          alt="Banner"
        />
      </div>
